...
# Write out to .csv for the raw data from ACS Data call to folder named "clean_data/acs_data_raw": 879241 obs. (same as API call) with 33 variables
...
merged_acs_data_scag <- read_csv("clean_data/acs_data_raw/merged_acs_data_scag.csv")
```
