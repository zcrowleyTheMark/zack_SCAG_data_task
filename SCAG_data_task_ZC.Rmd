...
# Pull out the first 4 digits from SERIALNO, which is the year of ACS for that observation:
...
# ADJINC has 6 implied decimal places so need to divide by 1000000
ca_pums_scag <- ca_pums_scag %>% mutate(housing_income = HINCP * (ADJINC/1000000))

# # If statement to switch between 2017-21 ACS data and 2018-22 ACS data:
# # If the min of year is 2017 and max is 2021, its the 2017-21 ACS data and use the ADJINC below to create "housing_income" variable:
# if (min(ca_pums_scag$year, na.rm = TRUE) == 2017 & max(ca_pums_scag$year, na.rm = TRUE) == 2021) {
# # Household Income for 2017-2021 ACS data:
# # # Create new variable "housing_income" by multiplying HINCP (household income) by ADJINC for correct year:
# ca_pums_scag <- ca_pums_scag %>% mutate(housing_income = case_when(ADJINC == 1117630 ~ HINCP * (1117630/1000000), # 2017 Adjust Income
#                                                                    ADJINC == 1093093 ~ HINCP * (1093093/1000000), # 2018 Adjust Income
#                                                                    ADJINC == 1070512 ~ HINCP * (1070512/1000000), # 2019 Adjust Income
#                                                                    ADJINC == 1053131 ~ HINCP * (1053131/1000000), # 2020 Adjust Income
#                                                                    ADJINC == 1029928 ~ HINCP * (1029928/1000000), # 2021 Adjust Income
#                                                                   )
#                                         ) 
# }
# 
# # If the min of year is 2018 and max is 2022, its the 2018-2022 ACS data and use the ADJINC below to create "housing_income" variable:
# if (min(ca_pums_scag$year, na.rm = TRUE) == 2018 & max(ca_pums_scag$year, na.rm = TRUE) == 2022) {
# # Household Income for 2018-2022 ACS data:
# # # Create new variable "housing_income" by multiplying HINCP (household income) by ADJINC for correct year:
