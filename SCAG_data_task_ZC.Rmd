...
merged_acs_data_scag <- merged_acs_data_scag %>% mutate(race = case_when(
...
merged_acs_data_scag <- merged_acs_data_scag %>% mutate(own_home = case_when(TEN == 1 | TEN == 2 ~ "Homeowner", 
                                                             TEN == 3 | TEN == 4 ~ "Non-Homeowner"
                                                            )) 
...
# Write out table to new sheet in excel file for tabbed SCAG output:
sheets <- list("Figure_22" = scag_homeownership_table) # scag_homeownership_table is a tibble
write_xlsx(sheets, "output/scag_tabbed.xlsx")
read_xlsx("output/scag_tabbed.xlsx")
```
