...
## Data Dictionary Table (New Variables for Analysis):
...
ACS_data_new_vars_tbl <- tribble(~ variable_name,           ~ description,       ~ type,   ~ levels,
                                 ...
                                 "poverty", "2 categories: If Yes, the HH income is below 200 percent of the poverty line", "factor", c("Yes","No"),
                                 ...
                                 "factor", c("Yes","No"),
                                 "no_kitchen_plumbing", "2 categories, If Yes, no kitchen and no plumbing facilities in home", "factor", c("Yes","No"),
                                "overcrowded",  "2 categories of Overcrowding of households, If Yes, household has more than 1.5 persons per room", "factor", c("Yes","No"),
                                 "hourly_wage", "Hourly Wage US dollars, adjusted for inflation","numeric", NA,
                                "unemployed", "Unemployment: if Yes, unemployed, No otherwise.", "factor", c("Yes","No"),
                                "age_3_cat", "3 categories of Single Parent Households by gender: female head of HH, male head of HH, or cohabitates or no kids", 
...
# county_levels: c("Imperial", "Los Angeles", "Orange", "Riverside", "San Bernardino", "Ventura", "SCAG")
county_levels <- append(county_levels, "SCAG") 

# race_levels: c("Asian/Pacific Islander", "Black", "Hispanic/Latino", "Multiracial/Other", "Native American", "White", "All Races")
race_levels <-  append(race_levels,  "All Races")
