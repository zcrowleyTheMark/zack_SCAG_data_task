...
# df = dataframe of all data, var = variable to sum over,  weight = weights, group = grouping variable, filter_value = value of a variable to filter output to, and 
...
weight_perc_table_filter <- function(df, var, weight, group, filter_value = NULL, group_label_totals = "SCAG") {
...
# Get no_kitchen_plumbing percentages by using weight_perc_2groups(), var = "overcrowded", and filter_value = "Yes":
...
### 
# Figure 22. Homeownership by Race and Ethnicity:
# Filter to only housing data (filter(RELSHIPP == 20)) and Use household weights- WGTP:

# Get no_kitchen_plumbing percentages by using weight_perc_2groups():
